package com.lda.rexman.uy.web.rest;

import com.lda.rexman.uy.config.Constants;
import com.lda.rexman.uy.RexManUyApp;
import com.lda.rexman.uy.domain.Authority;
import com.lda.rexman.uy.domain.User;
import com.lda.rexman.uy.repository.AuthorityRepository;
import com.lda.rexman.uy.repository.UserRepository;
import com.lda.rexman.uy.security.AuthoritiesConstants;
import com.lda.rexman.uy.service.MailService;
import com.lda.rexman.uy.service.dto.UserDTO;
import com.lda.rexman.uy.service.dto.PasswordChangeDTO;
import com.lda.rexman.uy.web.rest.errors.ExceptionTranslator;
import com.lda.rexman.uy.web.rest.vm.KeyAndPasswordVM;
import com.lda.rexman.uy.web.rest.vm.ManagedUserVM;
import com.lda.rexman.uy.service.UserService;
...
@SpringBootTest(classes = RexManUyApp.class)
